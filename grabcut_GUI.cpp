//This implemenets grabcut gui
//Created by Rahul Barnwal.

//Task to do: Add code for saving the output after each iteration 
...
{
    //sets the private variable image and winName and initialises mat mask image
...
void GCApplication::showImage() const
{
    ...
    imshow( *winName, res );
    //cv::imwrite("/Users/mi0307/grabcut-build/result.bmp", res);
...
int main( int argc, char** argv )
{
   /** cv::CommandLineParser parser(argc, argv, "{@input| ../data/messi5.jpg |}");
    ...
    Mat image = cv::imread("/Users/mi0307/Downloads/Sizing-Warehouse_cropped/2017-05-09/Shirts/1781395/1.bmp",1);
//    Mat image = cv::imread("/Users/mi0307/Desktop/mishra3.jpg",1);
...
//    cv::resize(image,image,size);
    ...
    /***
    cv::Rect boundrect(10,10,image.cols-20,image.rows-20);
